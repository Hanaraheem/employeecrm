...
urlpatterns = [
    ...
    path("employees/list",views.EmployeeListView.as_view(),name="emp-list"),
    # for id path:(update,delete,edict)
    ...
    path("employees/<int:pk>/remove",views.EmployeeDeleteView.as_view(),name="emp-delete"),
     path("employees/<int:pk>/change",views.EmployeeEditView.as_view(),name="emp-edit"),
